...
REM set D_ARGS="-Djogamp.debug.NativeLibrary=true" "-Dnativewindow.debug.GraphicsConfiguration"
...
set D_ARGS="-Dnewt.debug.Window" "-Djogl.debug.GLCanvas" "-Dnativewindow.debug.SWT" "-Dswt.autoScale.updateOnRuntime=true"
