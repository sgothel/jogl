...
GLAPI void APIENTRY glVertexAttribs1hvNV(GLuint index, GLsizei n, const GLhalf *v);
GLAPI void APIENTRY glVertexAttribs2hvNV(GLuint index, GLsizei n, const GLhalf *v);
GLAPI void APIENTRY glVertexAttribs3hvNV(GLuint index, GLsizei n, const GLhalf *v);
GLAPI void APIENTRY glVertexAttribs4hvNV(GLuint index, GLsizei n, const GLhalf *v);
#endif
...
#ifdef GL_GLEXT_PROTOTYPES
GLAPI void APIENTRY glPrimitiveRestartNV(GLvoid);
...
#ifdef GL_GLEXT_PROTOTYPES
GLAPI void APIENTRY glElementPointerNV(GLenum type, const GLvoid *pointer);
GLAPI void APIENTRY glDrawElementArrayNV(GLenum mode, GLint first, GLsizei count);
GLAPI void APIENTRY glDrawRangeElementArrayNV(GLenum mode, GLuint start, GLuint end, GLint first, GLsizei count);
GLAPI void APIENTRY glMultiDrawElementArrayNV(GLenum mode, const GLint *first, const GLsizei *count, GLsizei primcount);
...
/*
 * ckline: note, missing the following extensions
...
/*
 * note(ckline): manually created this definition from the specification at
